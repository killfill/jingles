...
angular.module('fifoApp')
  ...
  .factory('wiggle', function ($resource, $http, $cacheFactory, $q) {
    ...
    function setUpServices() {
      ...
      services.users= $resource(endpoint + 'users/:id/:controller/:controller_id/:controller_id1/:controller_id2/:controller_id3',
                       {id: '@id',
      ...
      services.groups= $resource(endpoint + 'groups/:id/:controller/:controller_id/:controller_id1/:controller_id2/:controller_id3',
                        {id: '@id',
                         controller: '@controller',
                         controller_id: '@controller_id',
                         controller_id1: '@controller_id1',
