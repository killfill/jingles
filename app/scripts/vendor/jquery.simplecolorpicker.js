  ...
  SimpleColorPicker.prototype = {
    ...
    init: function(type, select, options) {
      ...
      if (this.options.picker) {
        ...
        this.$icon = $('<span class="simplecolorpicker icon btn btn-mini" title="' + selectText + '" style="background-image: none; background-color: ' + selectValue + ';" role="button" tabindex="0">'
                      + 'Color'
